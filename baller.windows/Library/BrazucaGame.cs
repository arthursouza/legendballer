...
using baller.windows.Library.Scenes;
using baller.windows.Library.Simulation;
using baller.windows.Library.UI;
using baller.windows.Library.Util;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using Microsoft.Xna.Framework.Input;
using MessageBox = baller.windows.Library.UI.MessageBox;
using MouseCursor = baller.windows.Library.Input.MouseCursor;
...
namespace baller.windows.Library
{
    ...
    {
        public Input.MouseCursor MouseCursor;
