...
namespace LegendBaller.Library.Scenes
{
    public class MainMenuScene : Scene
    {
        ...
        public MainMenuScene(BrazucaGame game)
            : base(game)
        {
            studioLogo = new Rectangle(14, 613, 91, 91);
            studioToolTip = new Tooltip("Navigate to facebook.com/stuffgamestudio", Position.Zero);
            
            var newGame = new Vector2(BrazucaGame.WindowBounds.Width/2, 420);
            var loadGame = new Vector2(BrazucaGame.WindowBounds.Width/2, 510);
        ...
        {
            batch.Draw(Graphics.MainMenu, BrazucaGame.WindowBounds, Color.White);
