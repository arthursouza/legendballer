...
namespace BrazucaLibrary.Scenes
{
    public class SimulationScene : Scene
    {
        ...
        public SimulationScene(BrazucaGame game)
            : base(game)
        {
            this.Game = game;
        ...
        {
            batch.Draw(Graphics.SimulationBG, BrazucaGame.WindowBounds, Color.White);
            ...
            batch.DrawString(Fonts.Arial54, text, new Vector2(BrazucaGame.WindowBounds.Width - (windowPadding + Fonts.Arial54.MeasureString(text).X), windowPadding), Color.White);
